<style>
	#team_b_more_free_themes{
	background:transparent #fff;
	
	margin-top:40px;
	}
	#team_b_more_free_themes .hndle , #team_b_more_free_themes .handlediv{
	display:none;
	}
	#team_b_more_free_themes p{
	color:#000;
	font-size:15px;
	}
	...
	#team_b_more_free_themes .theme-id-container {
    position: relative;
    height: 49px;
}
#team_b_more_free_themes .theme-browser .theme .theme-name{
	    height: auto;
}#team_b_more_free_themes .theme-browser .theme .theme-actions{
	   opacity: 1;
}
</style>
